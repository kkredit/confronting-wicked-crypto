...
impossible to impose in a democratic system \cite{lindblom_muddling_1959}. \myfig{fig-muddling-through} illustrates this
method.
...
that none are particularly fond of ("As Lindblom's sobriquet suggests, it often led to a considerable muddle''
\cite{feeley_judicial_2000}). Consider application of the \ac{CFAA} as an example of this kind of muddle
