...
\newcommand{\eestart}{\begin{enumerate}}
\newcommand{\ee}[1]{\item \textbf{#1.}}
\newcommand{\eeend}{\end{enumerate}}

\newcommand{\eistart}{\begin{itemize}}
\newcommand{\ei}[1]{\item \textbf{#1.}}
\newcommand{\eiend}{\end{itemize}}
