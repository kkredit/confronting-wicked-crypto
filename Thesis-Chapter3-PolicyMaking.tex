...
solution in a way that doesn't leave vast swaths of people behind.

% TODO: what am I really trying to express here?
...
% solution from a different domain, or definitively evaluate its performance after the fact.

% Refining the problem statement and combining the
% tame elements into a cohesive solution is the ``wicked'' part.
...
% FIXME: include this idea somewhere in this section.
...
% TODO: Dulimarta: consider changing this heading to "Proposal: Observe-Orient-Decide-Act"
...
% TODO: Kalafut: It's not clear to me that this paragraph is a good fit here. It is good content. Perhaps this paragraph
% or its ideas should be at the start of the Argument Maps section.
...
restrained under a sound and agreeable strategy, can be addressed with \ac{incrementalism}. This process is demonstrated
in \myfig{fig-policy-ooda-process}.

% TODO: explain the icons
