...
loop. It is illustrated in \myfig{fig-ooda-loop}.
...
\cite{rittel_dilemmas_1973}. \myfig{fig-policy-ooda-loop} illustrates the \ac{OODAloop} modified to serve as a
...
% Preview it in action in the following chapters
