...
\newterm{argmap}{argument map}{
    Graphical representations of the logical structures and relationships between statements, premises, and conclusions,
    used to disentangle complex arguments used in wicked problems
}
% End terms
