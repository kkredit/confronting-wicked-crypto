...
proposed solutions must be analyzed at many levels. Some these factors are \ac{EA}'s relation to \ac{masssurv},
...
\acl{EA} arguments in detail, and demonstrate the security risks with data flow diagrams and threat analysis, focusing
on one particular EA proposal. The thesis concludes with research and policy paths forward in light of valid arguments
and threats.
