...
\section{Context of the Debate}
\label{sec-context}

The problem of strong encryption and exceptional access exists in a historical, regulatory, and technical context. The
following sections describe encryption basics, the history of the crypto wars, the present context, encryption
regulations, and some proposed technical \ac{EA} solutions.

\subsection{Encryption History}
\label{sec-crypto-history}

The section provides an overview of encryption from ancient to contemporary times.

\subsubsection{Encryption Basics}
\label{sec-history-basics}

% TODO: Cryptography is <blah blah>
...
% TODO: Public key cryptography is <blah blah>
...
\subsubsection{The First Crypto War}
...
1993, the Clinton administration introduced the \term{clipperchip} \cite{press_1993} with the goal of ``providing the
...
discovered flaws that allowed users to subvert the \term{clipperchip} mechanisms \cite{blaze_protocol_1994}, the
proposal died.

Despite the failure of the \term{clipperchip}, the debate over access to strong encryption continued, primarily focused
...
\subsubsection{The Second Crypto War}
...
caused a stir, it was the mass data collection under the agency's \term{PRISM} and related programs that caused the real
...
\paragraph*{\term{horsemen}} In the 1990s, an influential encryption advocate coined the phrase ``\term{horsemen-full}''
...
\begin{itemize}
    \item The \term{clipperchip} \cite{press_1993} \cite{thompson_2015}
