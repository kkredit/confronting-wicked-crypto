...
% FIXME: reading note: paragraph makes sense, but need to read it multiple times for it to sink in. Improve.
...
% FIXME: Jumping rather quickly from primitives to huge systems. Perhaps scale it more smoothly. Connect little
% primitives to higher technologies, higher technologies to underpinnings of network computer systems, and network
% computer systems as critical to these industries.
...
% FIXME: Kristen doesn't like the wording
...
% FIXME: The point is made--these developments made gov'ts uncomfortable (just look at these examples!)--but the line of
% thought is not clear enough to the reader.
...
% FIXME: export controls were a hot topic of the time, too. Can't just drop that thread.
...
% FIXME: introduce FISA above, in the "had already been expanding" section. Then we have more of a narrative of
% expanding power.
...
% FIXME: expand on "nothing to hide"? that the debate is more about ``Security vs. Security'' than ``Security vs.
...
% FIXME: determine correct usage of -- vs ---
...
proposals in \ac{the-cw1}.
% TODO: how so?
Previewing a common phrase in recent \ac{EA} arguments \cite{geller_2019}, the draft's
authors both used the phrase ``above the law'' in promotion of the bill.
% TODO: how does this differ from the new LEAD Act?
...
% TODO: China, see also blanchard_2017
...
the primary concern. \myfig{fig-dfd-demo} shows the basic elements of a \ac{DFD}. In this thesis I create \acp{DFD} in
this style to analyze the threats already present and those that \ac{EA} would introduce.
% TODO: reference forward chapter
