...
% properties below, similar to denning_taxonomy_1996
...
\cite{denning_taxonomy_1996}
\ac{clipperchip} \cite{blaze_protocol_1994}
% The technical approach used by the \ac{clipperchip} secret protocol hardware enabled split-key government escrow.

}

    \prop{Distributed key escrow}{

\cite{goos_oblivious_1996}
\cite{phan_key_2017}
