...
\newcommand{\lawstart}[0]{\begin{itemize}}
\newcommand{\law}[3]{\item #1: \textbf{#2} \cite{#3}} % Year, name, citation
...
% Established export controls over strong encryption techniques introduced ITAR (International Traffic in Arms
% Regulations) \cite{kehl_right_2015}
...
% \cite{wolff_computer_2016}
    ...
    \law{2001}{\acf{USAPATRIOT} Act}{sensenbrenner_2001}
    \law{2007}{\acf{PAA}}{mcconnell_s1927_2007}
    \law{2008}{\acf{FISAAA}}{reyes_hr6304_2008}
    \law{2015}{\acf{USAFREEDOM} Act}{sensenbrenner_2015}
\lawsend
...
% mix of SE protection and EA guidelines?
    \law{1998}{Encryption Protects the Rights of Individuals from Violation and Abuse in CYberspace (E-PRIVACY) Act}{ashcroft_s2067_1998}
% like above?
...
\newcommand{\countrystart}[0]{\begin{itemize}}
\newcommand{\country}[1]{\item \textbf{#1:}} % Country
\newcommand{\countryend}{\end{itemize}}
...
\newcommand{\propstart}[0]{\begin{itemize}}
\newcommand{\prop}[2]{\item \textbf{#1} \cite{#2}} % Proposal name, citation
\newcommand{\propend}{\end{itemize}}
