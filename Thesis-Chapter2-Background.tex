...
community to engage productively with policymakers \cite{granick_2018}.
...
Introduced by the same senator as the \ac{EARNITAct}, the \ac{LAEDAct} is a direct attack on encryption. The
\ac{LAEDAct} specifically addresses \ac{DAR} and \ac{DIM} by forcing device, operating system, and application
...
% Prof. Walsh:
% Due to the dynamic nature of future judicial rulings that may expand or retract the application of exceptional access
% it is beyond the scope of this research to comment further...
...
% FIXME: Engelsma: Consider moving this right after "encryption basics", as I have referred to many of these approaces
% already.
...
% FIXME: Separate out into separate, short chapter, probably after the wicked problems chapter. Also adds natural place
% to introduce my more "advanced" DFD syntax.

% TODO: include a more descriptive key to understand argument maps.
...
primary concern. \myfig{fig-dfd-demo} shows the basic elements of a \ac{DFD}. In \mychap{chap-threatmodel} I create
