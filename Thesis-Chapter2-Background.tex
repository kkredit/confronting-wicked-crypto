...
% TODO: explain public key cryptography enough to justify the following
...
% TODO: Kalafut: do these paragraphs belong here? It really is an aside on the importance of crypto. Possibly put in
%       their own section earlier.
...
% TODO: choose one.
Strong encryption's emergence caused the first crypto war, and now its proliferation has caused the second.

% The emergence of strong encryption caused the first crypto war, and now its proliferation has caused the second.

% The first crypto war resulted from strong encryption's emergence, and now the second has resulted from its
% proliferation.
