...
% TODO: after defense, create table of these and reference it in \prop lists below. This is better than sorting by
% historical origin.
...
There are several technical approaches to \ac{EA}. This section breaks down these approaches according to those
originating from \ac{the-cw1}, \ac{the-cw2}, and those that side-step the issue by using non-technical means to acquire
plaintext.
...
\newcommand{\prop}[3]{ % Name, citation, description
    \item \textbf{#1} \cite{#2} \nopagebreak
...
\propsstart
    \prop{\Ac{lawful-hacking}}{nguyen_lawful_2017}{}
