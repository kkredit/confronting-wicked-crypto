...
highly risky centralization of access capability \cite{schneier_ghost_2019}. It has the same nature, if a different
form, as rejected key escrow proposals.
...
\cite{savage_lawful_2018} \cite{ozzie_2018}. Such features precludes mass surveillance and ensure transparency to the
...
device's secure enclave, but devices already do---it is the same hardware devices that manages device unlock and
...
%% NOTE: not worth going into this section. Just describe a few and go straight to one of the most interesting.
